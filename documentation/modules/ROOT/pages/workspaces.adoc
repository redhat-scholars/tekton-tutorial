...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -n {chapter-namespace} -f $TUTORIAL_HOME/install/utils/nexus.yaml
----
...
[IMPORTANT]
====
OpenShift users can install Knative i.e https://docs.openshift.com/container-platform/4.1/serverless/installing-openshift-serverless.html[OpenShift Serverless] using Operators and skip this section.
====
...
[source,bash,subs="+macros,+attributes"]
----
kubectl get ksvc -n {chapter-namespace}
----
...
helloworld   http://helloworld.{chapter-namespace}.192.168.64.5.nip.io   helloworld-kffxd-1   helloworld-kffxd-1   True
----
