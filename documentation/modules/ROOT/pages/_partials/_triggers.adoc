...
+
--
NOTE: by default the greeter pipeline's default image tag that it builds to is the example.com addon registry for minikube.  Hence, no further updates to the TriggerTemplate is necessary
--
OpenShift::
+
--
