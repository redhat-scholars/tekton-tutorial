...
build-and-list-target                            15 hours ago
build-app                                        15 hours ago
----
...
+
--
Create the HTTPProxy to access the service:
[.console-input]
[source,bash,subs="+macros,attributes+"]
----
kubectl apply -n {tutorial-namespace} -f $TUTORIAL_HOME/kubernetes/http-proxy.yaml
----

[.console-output]
[source,bash]
----
httpproxy.projectcontour.io/greeter created
----

[.console-input]
[source,bash,subs="+macros,attributes+"]
----
SVC_URL=$(kubectl get httpproxy greeter -n tektontutorial -o=jso
npath='{.spec.virtualhost.fqdn}')
----
--
OpenShift::
+
