...
[WARNING]
====
PipelineResources will deprecated in future Tekton releases in favour of Workspaces. Expect this chapter to be removed in future release of the tutorial.
====
