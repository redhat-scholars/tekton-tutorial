...
----
kubectl apply -n {tutorial-namespace} -f link:{github-repo}/{pipelines-repo}/build-resources.yaml[build-resources.yaml]
----
...
[source,bash,subs="+macros,attributes+"]
----
oc apply -n {tutorial-namespace} -f link:{github-repo}/{pipelines-repo}/build-resources.yaml[build-resources.yaml]
----
...
tekton-tutorial-greeter-image   image   url: registry.kube-system:80/rhdevelopers/tekton-tutorial-greeter
----
